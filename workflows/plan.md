...
**Before generating your questions**, run silently: `prepcli delta questions --workflow=plan`
If it prints any questions, those are gaps that recurred on past plan tasks — fold the most relevant 1–2 into your four below. If it prints nothing, ignore it and continue.
...
```
prepcli delta add --workflow=plan --gap=<gap> --question="<the question that would have surfaced this up front>"
```
...
```
prepcli delta close --workflow=plan
```
