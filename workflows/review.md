...
**Before generating your questions**, run silently: `prepcli delta questions --workflow=review`
If it prints any questions, those are gaps that recurred on past review tasks — fold the most relevant 1–2 into your four below. If it prints nothing, ignore it and continue.
...
```
prepcli delta add --workflow=review --gap=<gap> --question="<the question that would have surfaced this up front>"
```
...
```
prepcli delta close --workflow=review
```
